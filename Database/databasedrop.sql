...
DROP INDEX IF EXISTS idx_admins_department;
DROP INDEX IF EXISTS idx_batches_department;
DROP INDEX IF EXISTS idx_batches_faculty;
DROP INDEX IF EXISTS idx_students_batch;
DROP INDEX IF EXISTS idx_subjects_department;
DROP INDEX IF EXISTS idx_batch_semester_subjects_batch;
DROP INDEX IF EXISTS idx_batch_semester_subjects_faculty;
DROP INDEX IF EXISTS idx_periods_batch_semester;
DROP INDEX IF EXISTS idx_timetable_batch;
DROP INDEX IF EXISTS idx_timetable_faculty;
DROP INDEX IF EXISTS idx_timetable_batch_semester;
...
DROP INDEX IF EXISTS idx_posts_creator;
